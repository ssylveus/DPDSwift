...
public class DPDHelper: NSObject {
    ...
    public class func toJsonString(data: AnyObject, prettyPrinted:Bool = false) -> String? {
    ...
    public class func writeArrayWithCustomObjToUserDefaults(key: String, array: [[String: AnyObject]]) {
    ...
    public class func readArrayWithCustomObjFromUserDefault(key: String) -> [[String: AnyObject]]? {
        let defaults = NSUserDefaults.standardUserDefaults()
    ...
    public class func saveToUserDefault(key: String, value: AnyObject) {
        let defaults = NSUserDefaults.standardUserDefaults()
        defaults.setObject(value, forKey: key)
        defaults.synchronize()
    }
    
    public class func retrieveFromUserDefault(key: String) -> AnyObject? {
        let defaults = NSUserDefaults.standardUserDefaults()
